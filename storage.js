...
function initializeData(){
  if(!getLS('products')){
    setLS('products',[
      {id:'p1',name:'Mango',description:'Sweet Alphonso Mangoes',price:349,stock:50,category:'Fruits',image:'https://images.unsplash.com/photo-1553279768-865429fa0078?w=800'},
      {id:'p2',name:'Banana',description:'Organic Bananas',price:120,stock:80,category:'Fruits',image:'https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=800'}
    ]);
  }
  if(!getLS('users')){
    setLS('users',[
